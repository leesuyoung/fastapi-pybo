...
<div class="container my-3">
    ...
    <div class="card my-3">
        <div class="card-body">
            ...
            <div class="my-3">
                <button class="btn btn-sm btn-outline-secondary" on:click="{vote_question(question.id)}">추천
    ...
    <!-- 답변 목록 -->
     ...
     <form method="post" class="my-3">
        <div class="mb-3">
         ...
         <input type="submit" value="답변등록" on:click="{post_answer}" class="btn btn-primary {$is_login ? '' : 'disabled'}">
     </form>
